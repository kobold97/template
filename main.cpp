...
#include "using_vector.h"		//defines template map_template<Key,Value>
#include <vector>

int main(void)
{
    typedef unsigned int ID; 							//Identification number of Employee
    assocTab<ID,Employee> Database;					//Database of employees
    ...
    assocTab<ID,Employee> NewDatabase = Database;	//Make a copy of database
